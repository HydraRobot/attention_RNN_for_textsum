...
class Example(object):
  ...
  def __init__(self, article, abstract_sentences, vocab, hps):
    ...
    #tf.logging.warning("original_article %s", self.original_article) 
    #tf.logging.info("original_abstract %s", self.original_abstract)
    #tf.logging.info("original_abstract_sents %s", self.original_abstract_sents)
    #tf.logging.info("target %s", self.target)
    #tf.logging.info("enc_input %s", self.enc_input)
    #tf.logging.info("dec_input %s", self.dec_input)
