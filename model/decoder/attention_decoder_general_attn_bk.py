    ...
    def attention(decoder_state, coverage=None):
      ...
      with variable_scope.variable_scope("Attention"):
        ...
        if use_coverage and coverage is not None: # non-first step of coverage
          ...
          # TODO:change e function
          #TODO: change e function: Wout[htd||cte||ctd] + bout)
          ...
          #decoder_state = tf.Print(decoder_state, [decoder_state.shape],"message=decoder_state shape", summarize=10000)
          #encoder_states = tf.Print(encoder_states, [encoder_states.shape],"message=encoder_states shape", summarize=10000)
          print("1 hi, bilinear")
          e = bilinear(decoder_state, encoder_state1)
